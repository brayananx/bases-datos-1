...
Un foreign key es una columna o grupo de columnas en una tabla de base de datos relacional que proporciona un vínculo entre los datos de dos tablas.
El foreign key, es un primary key de otra tabla.
